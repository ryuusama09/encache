...
var FIFO = /** @class */ (function (_super) {
    ...
    FIFO.prototype.safe = function (data) {
    ...
    FIFO.prototype.put = function (key, data) {
    ...
    FIFO.prototype.evict = function () {
        return __awaiter(this, void 0, void 0, function () {
            var key;
            return __generator(this, function (_a) {
                key = this.queue.shift();
                if (!key) {
                    return [2 /*return*/]; // Nothing to evict
                }
                try {
