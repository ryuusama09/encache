...
var Random = /** @class */ (function (_super) {
    ...
    Random.prototype.keys = function () {
        return Array.from(this.memory.store.keys());
    };
    Random.prototype.put = function (key, data) {
        return __awaiter(this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!!this.safe(data)) return [3 /*break*/, 3];
    ...
    Random.prototype.evict = function () {
        return __awaiter(this, void 0, void 0, function () {
            var keyList, randomKey;
            return __generator(this, function (_a) {
                keyList = Array.from(this.memory.store.keys());
